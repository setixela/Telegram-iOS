...
private final class PeerInfoScreenCallListItemNode: PeerInfoScreenItemNode {
    ...
    override func update(width: CGFloat, safeInsets: UIEdgeInsets, presentationData: PresentationData, item: PeerInfoScreenItem, topItem: PeerInfoScreenItem?, bottomItem: PeerInfoScreenItem?, hasCorners: Bool, transition: ContainedViewLayoutTransition) -> CGFloat {
        ...
        let addressItem = ItemListCallListItem(presentationData: ItemListPresentationData(presentationData), currentDateTimestamp: item.currentDateTimestamp, dateTimeFormat: presentationData.dateTimeFormat, messages: item.messages, sectionId: 0, style: .blocks, displayDecorations: false)
